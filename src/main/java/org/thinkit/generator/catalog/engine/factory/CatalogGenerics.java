...
/**
 * カタログクラスの総称型を生成する処理を定義したファクトリークラスです。
 * <p>
 * {@link #createResource()} メソッドを使用することで総称型を表現する文字列を取得することができます。
 *
 * @author Kato Shinya
 * @since 1.0.0
 */
...
public final class CatalogGenerics extends Generics {
     ...
     * デフォルトコンストラクタ
     */
    private CatalogGenerics() {
    }

    /**
     * {@link CatalogGenerics} クラスの新しいインスタンスを生成し返却します。
     *
